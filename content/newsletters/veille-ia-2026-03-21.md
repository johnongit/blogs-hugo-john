...
tags = ["mistral", "openai", "claude", "LLM", "FHE", "privacy", "open-source", "inference", "lean", "leanstral"]
categories = ["Veille IA"]
summary = "Semaine chargée autour de NVIDIA GTC : Mistral Small 4 en open-source, Leanstral pour Lean 4, GPT-5.4 mini et nano chez OpenAI, un nouveau modèle de modération Mistral, un aperçu de Claude Cowork Dispatch — et une percée en recherche sur l'apprentissage par renforcement sur données chiffrées."
description = "Veille IA du 15 au 21 mars 2026 : nouveaux modèles économiques (Mistral Small 4, Leanstral, GPT-5.4 mini/nano), modération Mistral v2, Claude Cowork Dispatch en research preview, et une publication Nature Machine Intelligence sur le reinforcement learning homomorphique."
+++
...
Mistral a publié [Leanstral](https://mistral.ai/news/leanstral), présenté comme le premier agent de code open-source conçu pour **Lean 4**, un proof assistant utilisé pour formaliser des preuves mathématiques et des spécifications logicielles. Le modèle est spécialisé plutôt que généraliste : architecture sparse avec **6 milliards de paramètres actifs**, publication des poids sous licence **Apache 2.0**, disponibilité dans Mistral Vibe et via un endpoint API `labs-leanstral-2603`.
...
Source : [Mistral AI, 16 mars 2026](https://mistral.ai/news/leanstral)
