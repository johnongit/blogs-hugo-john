...
description = "Veille IA de la semaine du 7 au 14 mars 2026 : analyse des outils retenus, signal institutionnel Anthropic, faux nouveaux de la semaine et points actionnables pour vos pipelines RAG et d'ingestion web."
+++
...
### Thread "Byzantine Generals + LLM agents" — @rryssf_

Thread viral cette semaine (2 400 likes), présenté comme une avancée récente sur la coordination des agents LLM via le problème des généraux byzantins. Recalé pour une raison simple : les travaux cités datent d'**octobre 2024** (arXiv:[2410.16237](https://arxiv.org/abs/2410.16237)) et de **novembre 2025** (arXiv:[2511.10400](https://arxiv.org/abs/2511.10400)). Ce n'est pas une nouveauté de la semaine, c'est une remontée algorithmique d'un contenu plus ancien. Les papiers eux-mêmes sont intéressants et méritent lecture, mais ils ne justifient pas une mention dans une veille de la semaine du 7 au 14 mars 2026.
